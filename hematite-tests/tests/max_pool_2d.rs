...
//
//! Per-op golden test: `KernelBackend::max_pool_2d` through `RefBackend`
//! (T5.1).

mod max_pool_fixture {
    include!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/goldens/max_pool_2d.rs"
    ));
}
